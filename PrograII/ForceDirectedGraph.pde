public class ForceDirectedGraph1 extends Viewport{
  ...
  public ForceDirectedGraph1(){
    ...
    this.dummyCenterNode = new Node("Z", 1.0f);
  }
  ...
  public void draw(){
    ...
    text("Energia cinetica total: " + this.totalKineticEnergy, this.getX(), this.getY());
    text("Constante de resorte: " + this.springConstant, this.getX(), this.getY() + offset);
    text("Constante de Coulomb: " + this.coulombConstant, this.getX(), this.getY() + offset * 2.0f);
    text("Coeficiente de oscilacion: " + this.dampingCoefficient, this.getX(), this.getY() + offset * 3.0f);
    text("Tiempo de ejecucion: " + this.timeStep, this.getX(), this.getY() + offset * 4.0f);
  }
